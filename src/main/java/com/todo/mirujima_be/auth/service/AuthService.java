...
public class AuthService {
  ...
  public LoginResponse login(LoginRequest loginRequest) {
    ...
    var password = passwordDecryptionService.decryptPassword(loginRequest.getPassword());
  ...
  public LoginResponse authenticateWithOAuth(String platform, String redirectUri, String code) {
    ...
    var oAuthService = oAuthServiceFactory.get(platform);
    var accessToken = oAuthService.getAccessToken(redirectUri, code);
    var userInfo = oAuthService.getUserInfo(accessToken);
