...
public class QBaseUserEntity extends EntityPathBase<BaseUserEntity> {
    ...
    private static final long serialVersionUID = 2136430592L;
    ...
    public QBaseUserEntity(Class<? extends BaseUserEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.lastCreatedUser = inits.isInitialized("lastCreatedUser") ? new com.todo.mirujima_be.user.entity.QUser(forProperty("lastCreatedUser")) : null;
        this.lastUpdatedUser = inits.isInitialized("lastUpdatedUser") ? new com.todo.mirujima_be.user.entity.QUser(forProperty("lastUpdatedUser")) : null;
    }
